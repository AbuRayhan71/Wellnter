...
const founders = [
  ...
  },
  {
    ...
    image: '/src/assets/1678113951491 copy.jpeg',
...
export function AboutUs() {
  const handleContactFounder = (founderName: string, linkedin: string) => {
    const subject = encodeURIComponent(`Connection Request - Wellnter`);
    const body = encodeURIComponent(`Hi ${founderName},

I'm interested in learning more about Wellnter and your work in academic mental health.

I'd love to connect and discuss:
- Your journey building Wellnter
- Academic mental health challenges
